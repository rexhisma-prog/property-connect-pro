    ...
    <tr>
      <td align="center">
        <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:#ffffff;padding:24px 40px;text-align:center;border-bottom:1px solid #f0f0f0;">
              <img src="https://daztdyskforqmcokwexv.supabase.co/storage/v1/object/public/property-images/branding%2Femail-logo.png" alt="ShitePronen.com" style="height:52px;width:auto;display:inline-block;" />
            </td>
          </tr>
          <tr>
